...
- This release candidate uses CentOS 7.3 as the default version. If you install DC/OS 1.9 by using the [GUI](/1.9/administration/installing/custom/gui/) or [CLI](/1.9/administration/installing/custom/cli/) install methods, your system will be automatically upgraded to CentOS 7.3.
